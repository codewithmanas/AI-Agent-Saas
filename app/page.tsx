        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center gap-10 mb-12 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Meet Your Personal{" "}
              <span className="bg-gradient-to-r from-blue-600 to-blue-400 text-transparent bg-clip-text">AI Content Agent</span>
            </h1>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white p-6 rounded-xl border border-gray-200 hover:border-blue-500 transition-all duration-300">
                    <div className={`h-12 w-12 rounded-lg flex items-center justify-center mb-4 ${feature.iconBg}`}>
